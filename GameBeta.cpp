...
// GameBeta.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CGameBetaApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CGameBetaApp

CGameBetaApp::CGameBetaApp()
{
...
// Единственный объект CGameBetaApp

CGameBetaApp theApp;


// Инициализация CGameBetaApp

BOOL CGameBetaApp::InitInstance()
{
